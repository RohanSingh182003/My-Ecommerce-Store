...
const Offers = () => {
    return (
        <>
            ...
            <h1 className='text-5xl font-semibold my-6 mx-auto md:ml-8'>Offers
            <span className='text-2xl ml-1 md:ml-2 text-slate-500 italic'>Section</span>
            <span className='ml-2 text-sm text-slate-400 block md:inline mt-1 md:mt-0'>Grab the latest deals now.</span></h1>
